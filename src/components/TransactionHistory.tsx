          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-secondary/50">
                ...
                <TableHead className="font-serif font-bold text-foreground">👤 Member</TableHead>
                ...
                <TableHead className="font-serif font-bold text-foreground">↩️ Returned</TableHead>
